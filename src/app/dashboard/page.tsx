    ...
    <div className="p-4 sm:p-6 space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <KPI
          ...
          color="amber"
          link="/dashboard/reports/ar-aging"
        />
        <KPI
          title="กระแสเงินสด"
          value={cf?.net ?? 0}
          ...
          link="/dashboard/reports/cash-flow"
        />
      </div>
      ...
      {ar && ar.items.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/dashboard/reports/ar-aging" className="text-sm text-blue-600 hover:underline">
              ดูทั้งหมด →
            </Link>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        <QuickLink href="/dashboard/invoices/new" label="ออกใบกำกับ" icon={Receipt} />
        <QuickLink href="/dashboard/quotations/new" label="สร้างใบเสนอราคา" icon={Receipt} />
        <QuickLink href="/dashboard/expenses" label="บันทึกค่าใช้จ่าย" icon={Wallet} />
        <QuickLink href="/dashboard/reports/vat" label="รายงานภพ.30" icon={Receipt} />
      </div>
    </div>
  );
}
