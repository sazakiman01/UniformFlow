  ...
  if (!company) {
    return (
      <div className="p-8 text-center">
        ...
        <Link href="/admin/company" className="text-blue-600 underline">ไปที่หน้าข้อมูลบริษัท</Link>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {(invoice.type === "tax_invoice" || invoice.type === "tax_invoice_receipt") &&
            ...
            canManageFinance && (
              <Link
                href={`/admin/credit-notes/new?invoiceId=${invoice.id}`}
          ...
          {invoice.creditNoteId && (
            <Link
              href={`/admin/credit-notes/${invoice.creditNoteId}`}
